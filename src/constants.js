...
export const THEMES = [
  ...
  },
  {
    ...
    bgTop: '#02182a',
    bgBottom: '#053a5d',
    platformColor: '#1f4a60',
    platformHighlight: '#2f6c86',
    platformDark: '#143342',
    pillarColor: '#173e52',
    pillarWidth: 10,
    underglowColor: [30, 150, 220],
    decorStyle: 'roots',
    ambientType: 'spores',
    ambientCount: 90,
  },
  {
    ...
    bgTop: '#111018',
    bgBottom: '#2a2230',
    platformColor: '#7d8693',
    platformHighlight: '#b4becd',
    platformDark: '#535b67',
    pillarColor: '#69717e',
    pillarWidth: 12,
    underglowColor: [200, 210, 225],
    decorStyle: 'rivets',
    ambientType: 'embers',
    ambientCount: 40,
  },
  {
    name: 'DUPONT CIRCLE DC',
    minRound: 16,
    bgTop: '#2e3f57',
    bgBottom: '#9f7252',
    platformColor: '#cc8d45',
    platformHighlight: '#ffd79e',
    platformDark: '#8a5424',
    pillarColor: '#b97637',
    pillarWidth: 9,
    underglowColor: [255, 180, 95],
    decorStyle: 'rivets',
    ambientType: 'stars',
    ambientCount: 75,
  }
