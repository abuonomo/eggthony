...
// ============================================================
// POOP BOMBS (used during wings mode)
// ============================================================
...
export function updatePoopBombs(dt) {
  ...
  for (let i = S.poopBombs.length - 1; i >= 0; i--) {
    const b = S.poopBombs[i];
    if (!b.active) { S.poopBombs.splice(i, 1); continue; }
